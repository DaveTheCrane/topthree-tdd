...
class ScoreAggregatorTest {
    ...
    void twoRecordsForDifferentPlayersProduceTwoPlayerAggregates() {
        ...
        ScoreRecord record2 = new ScoreRecord(new Player("p2", "Bob"), new GameEntry("g2", "Poker", 3, 30));
    ...
    void samePlayerIdWithDifferentDisplayNamesLastSeenNameWins() {
        ScoreRecord record1 = new ScoreRecord(new Player("p1", "Alice"), new GameEntry("g1", "Chess", 2, 50));
        ScoreRecord record2 = new ScoreRecord(new Player("p1", "Alicia"), new GameEntry("g2", "Poker", 3, 30));
